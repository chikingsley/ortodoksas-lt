...
const mediaManifestPath = join(publicDirectory, "media/manifest.json");
    ...
    try {
      const response = await fetch(candidate, {
        headers: {
          ...
          "User-Agent": "Mozilla/5.0 ortodoksas-lt-media/1.0",
        },
        redirect: "follow",
      ...
      await writeFile(join(publicDirectory, mediaPath), bytes);
      return {
