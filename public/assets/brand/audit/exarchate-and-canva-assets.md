...
`production/exarchate-lockup-client.png` is a byte-identical copy of the whitespace-trimmed client artwork. It is the sole production master for the Exarchate lockup. This preserves the client's exact symbol geometry, type, spacing, and palette.

The reconstructed SVG and its rendered derivative were removed from production. A future vector replacement requires an original file supplied or approved by the identity owner.
