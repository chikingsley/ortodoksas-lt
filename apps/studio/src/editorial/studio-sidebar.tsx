...
export const StudioSidebar = () => (
  <aside className="sticky top-0 z-20 flex h-screen flex-col border-border border-r bg-card max-inventory-mobile:static max-inventory-mobile:block max-inventory-mobile:h-16 max-inventory-mobile:w-full max-inventory-mobile:border-r-0 max-inventory-mobile:border-b">
    <div className="grid h-[76px] grid-cols-1 items-center gap-2.5 border-border border-b py-0 pr-3.5 pl-[18px] max-inventory-mobile:h-[63px]">
      <div>
    ...
    <div className="m-2.5 grid grid-cols-[32px_minmax(0,1fr)_16px] items-center gap-[9px] border-0 border-border border-t bg-card px-2 py-2.5 text-left max-inventory-mobile:hidden">
      <span className="grid size-[30px] place-items-center rounded-full bg-accent font-bold text-[11px] text-primary">
        SR
      </span>
